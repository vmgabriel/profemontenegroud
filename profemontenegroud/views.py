...
class PeriphepaltypeCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("profemontenegrouds:periphepaltypes")
...
def delete_periphepaltype_view(request, pk):
    ...
    return redirect("profemontenegrouds:periphepaltypes")
...
class PeriphepalCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("profemontenegrouds:periphepals")
...
def delete_periphepal_view(request, pk):
    ...
    periphepal.delete()
    return redirect("profemontenegrouds:periphepals")
...
class CameraCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("profemontenegrouds:cameras")
...
def delete_camera_view(request, pk):
    ...
    camera.delete()
    return redirect("profemontenegrouds:cameras")
...
class CameraperiphepalCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("profemontenegrouds:cameraperiphepals")
...
def delete_cameraperiphepal_view(request, pk):
    ...
    return redirect("profemontenegrouds:cameraperiphepals")
